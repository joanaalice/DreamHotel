...
namespace DataAccessLayer.Infraestructure
{
    public class ConnectionHelper
    {
        ...
        const string JoanaDBcasa = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\User\Documents\DataBaseHotel.mdf;Integrated Security=True;Connect Timeout=30";
